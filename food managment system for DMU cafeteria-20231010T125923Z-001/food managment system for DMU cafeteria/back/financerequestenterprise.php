...
?>
<?php
$itemselector=mysqli_query($conn,"select *from financerequest");
if($itemselector){
	$row=mysqli_fetch_array($itemselector);
	$importitem=$row['importitem'];
...
if(isset($_POST['submit']))
	...
	if($importitem===$item){
		...
		alert("  requested before")</script>';
	}


else if($importitem!==$item){
