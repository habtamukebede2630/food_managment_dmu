...
if($_SESSION['user']['role']=='admin'){
    header("location:finance/adminhome.php");
...
<div class="navbar">
    <ul class="ul_container" >
        ...
        <li class="li_class"> <a href="financehome.php">Home </a></li>
       
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="viewfinancerequest.php">Finance Request</a></li>
                <li class="li_class li-drop"><a href="viewnoncafefinance.php">Noncafe Student</a></li>
                <li class="li_class li-drop"><a href="internshippayment.php"> internship</a></li>
        ...
        <ul class="dropdown" >
        <li class="li_class li-drop"><a href="viewfinancerequest.php">Feedback</a></li>
        </ul>
    </li>
    <li class="li_class"><a href="#">pay</a>
     <ul class="dropdown">
     <li class="li_class li-drop"><a href="paynoncafe.php">Non-cafe</a></li>
     </ul>
         </li>
      
        <li class="li_class"><a href="../logout.php">LOGOUT</a>
    </li>
    </ul>
</div>
