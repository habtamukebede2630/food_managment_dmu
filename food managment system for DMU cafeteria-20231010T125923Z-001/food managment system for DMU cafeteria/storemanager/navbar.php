...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="storemanagerhome.php">Home </a></li>
        <li class="li_class" >
            <a href="#">Request </a>
            <ul class="dropdown" >
                <li class="li_class li-drop"><a href="requestmateriallack.php">Material lack </a></li>
            </ul>
        </li> 
        <li class="li_class"><a href="#"> view 
            
        <?PHP
	           	$i=0;
		   $query2=mysqli_query($conn,"select * from dailyexpenditure WHERE status='A' and day='$dattee'");
		...
		$i++;	
		 ...
		 ?> 
               ...
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="materialsreplay.php">materals replay</a></li>
                <li class="li_class li-drop"><a href="viewdailymenurequest.php">Daily menu request
                <?PHP
	           	$i=0;
		   $query2=mysqli_query($conn,"select * from dailyexpenditure WHERE status='A'");
            $w2=mysqli_num_rows($query2);
          if($w2){
		?>
		&nbsp;<img src="../images/111.png" height="15" width="15" align="top" align="right"/>
		...
		$i++;	
		 ...
		 ?> 
                ...
                <li class="li_class li-drop"><a href="remainingfood.php">Remaining food</a></li>
                <li class="li_class li-drop"><a href="totalimported.php">total imported</a></li>
            ...
            <ul class="dropdown" >
                <li class="li_class li-drop"><a href="incomingmaterial.php">Incoming material</a></li>
                <li class="li_class li-drop"><a href="incomingfood.php"> Incoming food</a></li>
