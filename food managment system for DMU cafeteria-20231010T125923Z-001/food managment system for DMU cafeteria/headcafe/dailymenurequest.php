...
<table border="1" width="650">
	...
	<tr>
		<center><th align="left" bgcolor="#959c9d" >Item name</th></center>
		<center><th align="left" bgcolor="#959c9d" >Daily expenditure</th></center>
	</tr>
	<?php
	$date=Date('Y/m/d');
	$dattee=Date('l',strtotime($date));
...
$resultbreak=mysqli_query($conn,"select *from student where status='break'")or die(mysqli_error());
$break=mysqli_num_rows($resultbreak);
$currentstudent=$totalstud-($noncafe+$internship+$punish+$break);
	...
	while($row=mysqli_fetch_array($sql))
	{
		...
		$daily=$currentstudent*$daily;
			...
			echo"<tr><td>".$itemname."</td><td>".$daily."&nbsp;&nbsp;".$scale."</td></tr>";
