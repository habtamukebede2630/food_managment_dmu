...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="headhome.php">Home </a></li>
        <li class="li_class" >
            <a href="#">Request </a>
            <ul class="dropdown" >
                <li class="li_class li-drop"><a href="headrequest.php">Internship </a></li>
               
            </ul>
        </li> 
        <li class="li_class"><a href="#"> Update </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="headupdate.php">Student Status</a></li>
