...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="merchanthome.php">Home </a></li>
        
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="importitems.php">Items to import</a></li>
                <li class="li_class li-drop"><a href="#"> Feedback </a></li>
                </ul>
           </li>
           <li class="li_class"><a href="#">Request</a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="merchantrequest.php">Finance</a></li>
