...
<body>
    ...
    <div class="navbar">
        <ul class="ul_container" >
            <li class="li_class"> <a href="enterprisehome.php">HOME </a></li>
            <li class="li_class" >
                <a href="#"> View </a>
                <ul class="dropdown" >
                    <li class="li_class li-drop"><a href="enterpriseimport.php">Items to import</a></li>
                    <li class="li_class li-drop"><a href="acceptedrequestenterprise.php">Accepted Request</a></li>
                    <li class="li_class li-drop"><a href="rejectedrequest.php">Rejected Request</a></li>
                   
                </ul>
            </li> 
            <li class="li_class"><a href="#">Request  </a>
                <ul class="dropdown" >
                    <li class="li_class li-drop"><a href="financerequestenterprise.php">Finance </a></li>
