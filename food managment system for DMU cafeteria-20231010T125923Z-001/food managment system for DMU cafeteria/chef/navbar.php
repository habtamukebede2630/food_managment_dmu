...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="chefhome.php">Home </a></li>
        <li class="li_class" >
            <a href="#">Check </a>
            <ul class="dropdown" >
                <li class="li_class li-drop"><a href="dailymenuchef.php">Daily Menu </a></li>
        ...
        <li class="li_class" >
            <a href="#">Send </a>
            <ul class="dropdown" >
                <li class="li_class li-drop"><a href="sendcommentchef.php">Send comment</a></li>
                
            </ul>
        </li> 
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="chefViewstatus.php">Student Status</a></li>
