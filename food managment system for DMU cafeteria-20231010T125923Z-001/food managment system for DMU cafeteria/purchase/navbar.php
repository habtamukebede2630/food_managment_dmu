...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="purchasehome.php">Home </a></li>
        <li class="li_class" >
            <a href="#">Send </a>
            <ul class="dropdown" >
        ...
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="#">Finance Request</a></li>
                <li class="li_class li-drop"><a href="acceptmateriallackrequest.php">Material Lack</a></li>
                <li class="li_class li-drop"><a href="#">Feedback</a></li>
                </ul>
           </li>
