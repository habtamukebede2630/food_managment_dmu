...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="presidenthome.php">Home </a></li>
        
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="Annualpresident.php">Annual Reports</a></li>
                <li class="li_class li-drop"><a href="reportspresident.php"> Reports Between</a></li>
                <li class="li_class li-drop"><a href="#"> Feedback </a></li>
                </ul>
           </li>
        <li class="li_class"><a href="backup.php">Send</a>
        <ul class="dropdown">
        <li class="li_class li-drop"><a href="#"> Feedback </a></li>
        </ul>
         </li>
