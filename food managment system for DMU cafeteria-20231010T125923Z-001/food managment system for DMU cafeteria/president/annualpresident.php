...
echo "<tr><td colspan='2'><center>Total</center></td><td>".$product2."Birr</td></tr><tr></tr></table>";
?><br><br>
<h1>food Items Expended</h1>
<table border='1' width="600px" bgcolor="#cdd7dc"><th>Item Name</th><th>Expenditure</th><th>Total Price</th>
<?php
...
while($row2=mysqli_fetch_array($sql4))
{
	...
	echo "<tr><td>".$item."</td><td>".$sum."</td><td>".$sum*$price."&nbsp;&nbsp; Birr"."</td></tr>";
	
	
	
	}
}}echo "<tr><td colspan='2'><center>Total</center></td><td>".$produc."</td></tr><tr></tr>";

?>
</center>
</table><br>
<h2>Avilable Items In store</h2>
<table border="1" width="600px" bgcolor="#cdd7dc">
...
echo "<tr><td>".$item."</td><td>".$quantity."&nbsp;&nbsp;&nbsp;".$scale."</td></tr>";
	...
	$dg=0;
	$birr=0;
	$sqw=mysqli_query($conn,"select * from birr where fod='internship'and status='accept'");
	...
	$sqw1=mysqli_query($conn,"select * from birr where fod='For non-cafe' and status='accept'");
...
////////////////for special case 	
	...
	?>
	  ...
	  <table border="1" bgcolor="#cdd7dc" width="600">
