...
while($row=mysqli_fetch_array($sql))
{
	...
	if($num=='0')
	{
		...
		$as=$price*$sum;
	echo "<tr><td>".$item."</td><td>".$sum."</td><td>".$as."</td></tr>";
...
?><br><br>
<h1>food item list that were eaten</h1>
...
<h2>Food itemes Availiable at stores</h2>
...
////////////////for special case 	
	...
	?>
      <p><h1><center>Summary of Annual Report</center></h1></p>
