...
<div class="navbar">
    <ul class="ul_container" >
        <li class="li_class"> <a href="vicepresidenthome.php">Home </a></li>
        
        <li class="li_class"><a href="#">View  </a>
               <ul class="dropdown" >
                <li class="li_class li-drop"><a href="betweenvice.php">Reports Between</a></li>
                <li class="li_class li-drop"><a href="viceannual.php">Annual Report</a></li>
                <li class="li_class li-drop"><a href="#"> Feedback </a></li>
                </ul>
           </li>
        <li class="li_class"><a href="#">Send</a>
        <ul class="dropdown" >
                <li class="li_class li-drop"><a href="betweenvice.php">Feedback</a></li>
        </ul>
       </li>
