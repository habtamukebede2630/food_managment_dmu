...
<div class="padder">
<?php
if(isset($_SESSION['user']['username'])&&isset($_SESSION['user']['password'])&&isset($_SESSION['user']['password'])){
  $username=$_SESSION['user']['username'];
  $query1=mysqli_query($conn,"select *from user where user_id='$username'");
  while($query2=mysqli_fetch_array($query2)){
    $role=$query2['role'];
  }
}
?>
...
echo "<td><a href=deletefeadbackadmin.php?id=".$query2['id'].">";?> <img src="../images/del.png" width="40" width="50"/> </a></td>
